...
V8cTracingController::V8cTracingController()
  ...
  LOG(INFO) << "YO THOR - V8C TRACING CONTROLLER - CTOR";
...
void V8cTracingController::StartTracing(
  ...
  LOG(INFO) << "YO THOR - V8C TRACING CONTROLLER - START TRACING";
...
//   }
//
//   // Construct a new |JSONTraceWriter| to generate JSON of one event at a
//   time.
...
//
//   // Write this one event to the stream and pass the JSON to the delegate.
//   The
//   // |JSONTraceWriter| hasn't written the "]}" closing to the stream yet
//   since
