...
StarboardAudioDeviceFactory::StarboardAudioDeviceFactory() {
  LOG(INFO) << "YO THOR Register StarboardAudioDeviceFactory";
}

StarboardAudioDeviceFactory::~StarboardAudioDeviceFactory() {
  LOG(INFO) << "YO THOR Unregister StarboardAudioDeviceFactory";
}
...
StarboardAudioDeviceFactory::NewAudioRendererSink(
  ...
  LOG(INFO) << "YO THOR NEW AUDIO RENDERERRRR SINK";
